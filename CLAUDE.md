...
# Bundle dev em ~/Applications + verificações online (ao vivo, plano B, limpeza, narração e GPT-Live) com a API key do Keychain
./scripts/run-dev-app.sh --selftest

# Compilar e correr em modo dev (cria app bundle em ~/Applications)
