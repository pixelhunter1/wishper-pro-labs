...
- macOS 13 or later (the bubble uses Liquid Glass on macOS 26)
...
- Audio is kept in memory for the duration of the dictation and never written to disk.
...
.build/debug/WishperPro --selftest   # 122 offline checks, no network
